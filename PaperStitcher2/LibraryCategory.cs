...
{
    public class LibraryCategory : LibraryTreeItem
    {
        ObservableCollection<LibraryItem> m_children;

        public LibraryCategory(string name, string iconSource)
        {
            m_children = new ObservableCollection<LibraryItem>();
